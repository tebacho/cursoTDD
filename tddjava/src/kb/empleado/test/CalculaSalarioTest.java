...
import kb.empleado.java.CalculadoraFactory;
...
public class CalculaSalarioTest {
	...
	private CalculadoraSalarioKB calculadoraNeto;
	private CalculadoraSalarioKB calculadoraBruto;
	
	@Before
	public void setUp() throws Exception {
		vendedor = new Vendedor();
		encargado = new Encargado();
		calculadoraFactory = CalculadoraFactory.getInstance();
		calculadoraNeto = calculadoraFactory.getCalculadoraSalarioKBNeto();
		calculadoraBruto = calculadoraFactory.getCalculadoraSalarioKBBruto();
	}
	@Rule
	...
	public void CalculaSalarioNetoCorrecto() {
		...
		assertEquals(calculadoraNeto.calculaSalario(salarioBruto),resultado,0);
	...
	public void CalculaSalarioNetoCorrectoDecimales() {
		...
		assertEquals(calculadoraNeto.calculaSalario(salarioBruto),resultado,0.001);
	}
	@Test
	...
	public void CalculaSalarioNetoIncorrectoNegativo() {
		...
		calculadoraNeto.calculaSalario(salarioBruto);
	}
	@Test
	public void CalculaSalarioBrutoVendedorCorrecto() {
		...
		assertEquals(SalarioBrutoEsperado,calculadoraBruto.calculaSalario(vendedor, ventasMes, horasExtra),0);
	}
	@Test
	...
	public void CalculaSalarioBrutoEncargado() {
		...
		assertEquals(SalarioBrutoEsperado,calculadoraBruto.calculaSalario(encargado, ventasMes, horasExtra),0);
	}
	@Test
	...
	public void CalculaSalarioBrutoEncargadoErrorDolar() {
		...
		calculadoraBruto.calculaSalario(encargado, ventasMes, horasExtra);
	}
	@Test
	...
	public void CalculaSalarioBrutoNullEmpleado() {
		...
		calculadoraBruto.calculaSalario(null, ventasMes, horasExtra);
	}
